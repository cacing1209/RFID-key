...
Sistem locker sekolah berbasis kartu RFID. Setiap controller mengelola sampai **30 locker** (1 unit Mega), bisa di-deploy dalam beberapa varian model (`J508` … `J502`) yang membedakan mapping pin relay sesuai layout PCB.
...
| 7 varian model (`J508`…`J502`) via `#define`  | ✅     |
...
- **Pilih SATU model** dengan `#define modelL0xxx` (varian `J508`/`J506`/`J504`/`J505`/`J503`/`J501`/`J507`/`J502`). Compile-time error kalau salah pilih.
