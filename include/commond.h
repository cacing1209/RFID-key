...
#define modelJ502 // MODUL NO NAME
...
#define COUNT_MODELS (              \
    ...
    (defined(modelJ503) ? 1 : 0) + \
    (defined(modelJ501) ? 1 : 0) + \
    (defined(modelJ507) ? 1 : 0) +  \
    (defined(modelJ502) ? 1 : 0))
...
private:
    ...
    const char *controller_name = "J502";
#endif
